...
QT_MOC_LITERAL(1, 7, 12), // "SignalNotify"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 7) // "message"

    },
    "Source\0SignalNotify\0\0message"
};
...
void Source::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SignalNotify((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Source::SignalNotify)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Source::SignalNotify(QString _t1)
{
