...
QT_MOC_LITERAL(1, 4, 7), // "SuaGoGo"
QT_MOC_LITERAL(2, 12, 0), // ""
QT_MOC_LITERAL(3, 13, 7), // "TypeSua"
QT_MOC_LITERAL(4, 21, 4) // "TYPE"

    },
    "Dog\0SuaGoGo\0\0TypeSua\0TYPE"
};
...
void Dog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->SuaGoGo((*reinterpret_cast< TypeSua(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Dog::*)(TypeSua );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Dog::SuaGoGo)) {
                *result = 0;
                return;
            }
        }
...
void *Dog::qt_metacast(const char *_clname)
{
    ...
    return BaseAnimal::qt_metacast(_clname);
}

int Dog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = BaseAnimal::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 1)
